        ...
        <Box m={3}>
            <Grid container spacing={3}>
                <Grid item md={2} className="border-right">
                    <div className="m-5">
                        <img src="https://1000marcas.net/wp-content/uploads/2020/02/YouTube-logo.png" className="img-fluid img-logo"
                            alt="logo" />
                        <div className="mt-5">
                            <h6>MENU</h6>
                            <ul>
                                ...
                                <li>
                                    <a href="#"><i className="fa-brands fa-youtube"></i>&nbsp;Subscription</a>
                                </li>
                                <li>
                        ...
                        <div className="mt-5">
                            ...
                            <ul>
                                <li>
                                    <a href="#"> <i className="fa-solid fa-circle-question"></i>&nbsp;Settings</a>
                                </li>
                                <li>
                                    <a href="#"><i className="fa-solid fa-gear"></i>&nbsp;Help</a>
                                </li>
                                <li>
                                    <a href="#"><i className="fa-solid fa-comments"></i>&nbsp;FeedBack</a>
                                </li>
                            </ul>
                        </div>
                    </div>
